  ...
  className={`${styles.paddings} py-8 relative`}>
    ...
    <div className={`${styles.innerWidth}mx-auto flex flex-col gap-8`}>
            <div className="flex items-center justify-between flex-wrap gap-5">
              ...
              <button type="button"className="flex items-center h-fit px-6 py-4 bg-[#25628b]  rounded-[32px] gap-[12px] ">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center justify-between  flex-wrap gap-4">
              <h4 className="font-extralight text-[24px] text-white">Metaversus</h4>
              <p className="font-normal text-[14px] text-white opacity-50">METAVERUS
