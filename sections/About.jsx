...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{once:false,amount:0.2}}
      ...
      <TypingText title=" | About Metaversus" textStyles="text-center"/>
        ...
        className="mt-[8px] font-normal sm:text-[32px] text[20px] text-center text-secondary-white">
                  <span className="font-extrabold text-white ">Metaverse </span>   
                     ...
                     <span className="font-extrabold text-white "> the madnees of the metaverse </span>   
                      of today, using only
